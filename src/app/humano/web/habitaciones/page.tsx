...
const pageNavItems = [
  ...
  { label: "Servicios", href: "/humano/web#experiencias" },
  { label: "Experiencia", href: "/humano/web#experiencias" },
  ...
  return (
    <div className={`${bodyFont.className} bg-[var(--color-crema)] text-[var(--color-azul-rgb)]`}>
      ...
      <main>
        ...
        >
          <div className="absolute inset-0">
            <Image
              ...
              sizes="100vw"
            />
            <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,55,68,0.94)_0%,rgba(0,55,68,0.8)_48%,rgba(0,55,68,0.5)_100%)]" />
            ...
            <Reveal>
              <div className="grid gap-10 lg:grid-cols-[minmax(0,760px)_300px] lg:items-end lg:justify-between lg:gap-12">
                ...
                <div className="max-w-[420px] justify-self-start lg:w-[420px] lg:justify-self-end lg:translate-y-2">
                  <div className="rounded-[28px] bg-white/[0.08] px-5 py-4 text-white shadow-[0_10px_24px_rgba(0,0,0,0.12)] backdrop-blur-md">
        ...
        <section
          id="habitaciones"
          className="relative z-10 -mt-8 pb-24 pt-8 sm:-mt-10 sm:pb-28 sm:pt-10"
        >
          <div
            aria-hidden="true"
