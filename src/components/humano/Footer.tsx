...
import { HumanoWordmark } from "@/components/humano/HumanoWordmark"
        ...
        <footer ref={ref} className="relative bg-[#003744] border-t border-white/10">
            <div className="max-w-screen-2xl mx-auto px-6 lg:px-12">
                ...
                <div className="py-16 relative">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start mb-20 gap-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-16">
                            ...
                            <div className={`${inView ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: "0.15s" }}>
                                <h3 className="text-sm font-bold mb-4 text-[#F5F5DC]">Hotel</h3>
                                <ul className="space-y-3">
                                    <li>
                                        <a href="#" className="text-sm text-[#F5F5DC]/70 hover:text-[#F5F5DC] transition-colors">
                                            Habitaciones
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div className={`${inView ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: "0.25s" }}>
                                <h3 className="text-sm font-bold mb-4 text-[#F5F5DC]">Servicios</h3>
                                <ul className="space-y-3">
                                    <li>
                                        <a href="#" className="text-sm text-[#F5F5DC]/70 hover:text-[#F5F5DC] transition-colors">
                                            Restaurante
                            ...
                            <div className={`${inView ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: "0.35s" }}>
                                <h3 className="text-sm font-bold mb-4 text-[#F5F5DC]">Contacto</h3>
                                <ul className="space-y-3">
                                    <li>
                                        <a href="#" className="text-sm text-[#F5F5DC]/70 hover:text-[#F5F5DC] transition-colors">
                                            Nosotros
                    ...
                    {/* Center - Large Logo */}
                    <div className={`flex items-center justify-center mb-16 px-4 ${inView ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: "0.5s" }}>
                        <HumanoWordmark className="w-full max-w-[90vw] lg:max-w-[80vw] h-auto text-[#F5F5DC]" />
                    </div>
                </div>

                {/* Bottom Bar */}
                <div className={`border-t border-white/10 py-6 ${inView ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: "0.65s" }}>
